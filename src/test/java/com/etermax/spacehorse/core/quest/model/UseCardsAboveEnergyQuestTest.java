...
public class UseCardsAboveEnergyQuestTest {
	...
	public void setUp() {
		...
		questDefinition = new QuestDefinition(QUEST_ID, QuestType.QUEST_USE_CARDS_ABOVE_ENERGY, CHEST_ID, GOAL_AMOUNT, REQUIRED_ENERGY,
	...
	private CardDefinition buildCardDefinition(String cardId, long energyCost) {
		return new CardDefinition(cardId, CardRarity.COMMON, 0, (int) energyCost);
	}
	...
	@Test
	public void usingCardsAboveEnergyCompletesQuest() {

		givenACardsAboveEnergyQuest();
	...
	@Test
	public void usingCardsBelowEnergyDontCompletesQuest() {
	...
	private void givenACardsAboveEnergyQuest() {
