...
@DynamoDBTable(tableName = "android_purchase")
public class AndroidPurchaseReceipt implements AbstractDynamoDAO {

	public static final String USER_INDEX_NAME = "androidPurchaseIndexbyUserId";
	...
	public AndroidPurchaseReceipt() {
	}

	public AndroidPurchaseReceipt(AndroidReceipt receipt, String userId) {
		this.transactionId = receipt.getTransactionId();
		this.productId = receipt.getProductId();
		this.data = receipt.getDataAsString();
		this.signature = receipt.getSignature();
		this.userId = userId;
	}

	public AndroidPurchaseReceipt(String transactionId) {
